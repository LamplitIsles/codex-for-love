...
try {
  ...
  for (const file of ['bin/codex-for-love.mjs', 'vendor/runtime/cli.mjs', 'vendor/runtime/companion-mcp.mjs', 'vendor/runtime/session-start-hook.mjs', 'vendor/build/index.html', 'vendor/licenses/NotoSansSC-OFL-1.1.txt', 'vendor/licenses/jaminzhou-codex-app-server-client-MIT.txt', 'vendor/licenses/openai-codex-generated-Apache-2.0.txt']) if (!files.has(file)) throw new Error(`${name} omits ${file}.`);
